...
parser.add_argument('--lr', type=str, default='[0.0001]*15000', help='learning rates for steps(list form)')
...
parser.add_argument('--dataset', default='violence', help='dataset to train on (shanghai, ucf, ped2, violence, TE2)')
...
parser.add_argument('--max-epoch', type=int, default=700, help='maximum iteration to train (default: 1000)')
...
parser.add_argument('--aggregate_audio', action='store_true', default=False, help='whether to aggregate audio features')
