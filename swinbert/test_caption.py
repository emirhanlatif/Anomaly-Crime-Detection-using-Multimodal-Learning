...
def update_existing_config_for_inference(args):
    ...
    '''
    checkpoint = 'C:\\Users\\Emirhan\\Desktop\\tevad\\TEVAD\\swinbert\\SwinBERT\\models\\table1\\vatex'
    try:
    ...
    train_args.resume_checkpoint = args.eval_model_dir + '\\best-checkpoint\\model.bin'
    
    train_args.model_name_or_path = 'C:/Users/Emirhan/Desktop/tevad/TEVAD/swinbert/SwinBERT/models/captioning/bert-base-uncased/'
...
def get_custom_args(base_config):
    ...
    parser.add_argument("--file_type", type=str, choices=['video', 'image'] ,default='video')
...
def generate_emb():
    ...
    caption_path = "C:\\Users\\Emirhan\\Desktop\\deneme.txt"
    output_path = 'C:\\Users\\Emirhan\\Desktop\\features\\text\\'
    ...
    with open(caption_path) as f:
        for line in f:
            ...
            emb_path = output_path + vid_name + "_emb.npy"
...
def abc(video):
    ...
    video_name = video
    test_video_fname = 'C:\\Users\\Emirhan\\Desktop\\tevad\\TEVAD\\single_test\\ornek_video\\' + video_name
    resume_checkpoint = 'C:\\Users\\Emirhan\\Desktop\\tevad\\TEVAD\\swinbert\\SwinBERT\\models\\table1\\vatex\\best-checkpoint\\model.bin'
    caption_file = 'C:\\Users\\Emirhan\\Desktop\\deneme.txt'
    ...
    logger.info(f"Loading state dict from checkpoint2 {resume_checkpoint}")
    cpu_device = torch.device('cpu')
    pretrained_model = torch.load(resume_checkpoint, map_location=cpu_device)
    ...
    cap = inference(args, test_video_fname, vl_transformer, tokenizer, tensorizer)

    text = {
        test_video_fname: cap
    }
    cap_file.writelines(json.dumps(text) + "\n")
    cap_file.flush()

    embeddings = generate_emb()
